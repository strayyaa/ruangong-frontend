<template>
  <div>
    ...
    >
      ...
      <!-- <el-menu-item  index="/selectCourseList" class="el-menu-item-trans">全校课程</el-menu-item> -->
       <el-menu-item index="/" class="el-menu-item-trans">通知</el-menu-item>
      ...
      <el-menu-item index="/" class="el-menu-item-trans">登出</el-menu-item>
    </el-menu>
  </div>
</template>
